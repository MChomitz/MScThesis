...
\committee{%
	...
	\member{Dr.\ John Bonhoeffer}{Senior Supervisor\\Professor}
...
\backmatter%
	...
	\bibliographystyle{unsrt}%unsrt} %% default style is {plain}, but it outputs the list alphabetically by first author, unsrt will order the list by citation order
