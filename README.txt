...
The mythesis.tex file contains only the commands needed to create the thesis. All chapters (and possible future apendices) should be /include()ed in that file.
