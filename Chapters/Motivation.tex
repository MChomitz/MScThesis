...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		It is important to restate that the MIM does not report absolute $n$, but relative $n$.
		...
		However, the small number of initiators, means that the cell-to-cell variability can be important.
		The question we set out to answer with this research is, thus, \emph{how does variability in the initiation factor affect the replication program?}
