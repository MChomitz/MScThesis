...
These origins are somehow able to coordinate their stochastic initiation times such that it is rare for any part of the DNA to be left unreplicated by the end of S phase~\cite{eukaryotereview}.
	...
	\begin{figure}[tbh]
		...
		\end{center}
			\caption[Comparing Crystallization with Replication]{\label{fig:CrystalVsReplication} Comparison between the one-dimensional KJMA crystallization model and DNA replication.
